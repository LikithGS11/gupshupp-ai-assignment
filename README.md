...
- Dark-themed, accessible layout optimized for recruiters and demonstrations.
- JSON preview + copy-to-clipboard + export options for quick inspection and sharing.
